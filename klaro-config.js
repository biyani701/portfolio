// Define Klaro configuration under a custom global variable
// This will be referenced by the Klaro script via the data-klaro-config attribute
window.myKlaroConfig = {
